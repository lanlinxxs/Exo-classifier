...
def run_svm_cross_validation(data_dir, n_splits=5):
    """
    执行SVM交叉验证分类
    修改：增加详细的统计信息输出
    """
    ...
    plt.title('Average Confusion Matrix (values rounded to 5 decimal places)')
...
run_svm_cross_validation(data_directory, n_splits=5)
